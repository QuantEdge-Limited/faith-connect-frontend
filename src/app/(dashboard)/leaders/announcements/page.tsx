...
const INITIAL_ANNOUNCEMENTS: Announcement[] = [
  { 
    ...
    date: "2023-10-15", 
    content: "Join us for our annual harvest celebration! Food, fellowship, and fun for the whole family. Bring a dish to share!", 
    priority: 'high'
  },
  { 
    id: "2", 
    ...
    date: "2023-10-05", 
    content: "Wednesday Bible study starts this week at 7 PM in the fellowship hall. New members always welcome!", 
    priority: 'normal'
  },
];
...
export default function ParishAnnouncementsPage() {
  ...
  const getPriorityBadge = (priority: 'high' | 'normal' | 'low' | undefined) => {
    switch (priority) {
      case 'high':
        return (
          ...
          <div className="text-center py-16">
            <div className="w-16 h-16 mx-auto bg-amber-100 rounded-full flex items-center justify-center mb-4">
              <svg className="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2V7a2 2 0 00-2-2h-5m-4 0V4a2 2 0 012-2h4a2 2 0 012 2v1m-4 11h4m-4 0a2 2 0 100-4 2 2 0 000 4z" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No announcements yet</h3>
            <p className="text-gray-600 max-w-md mx-auto">
              Create your first announcement to share important updates with your parish community.
            </p>
            <button
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      <span className="text-sm text-gray-600 font-medium">{ann.date}</span>
                    </div>
                  </div>

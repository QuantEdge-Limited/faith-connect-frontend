...
export default function SettingsPage() {
  ...
  const handleClearLocalStorage = () => {
    if (confirm('This will clear all locally saved data including attendance records. Are you sure?')) {
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <label htmlFor="notifications.announcements" className="block text-sm font-medium text-gray-900">
                        Announcements
                      </label>
                      <p className="text-sm text-gray-600">Get notified when new announcements are posted</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <label htmlFor="notifications.attendanceReminders" className="block text-sm font-medium text-gray-900">
                        Attendance Reminders
                      </label>
                      <p className="text-sm text-gray-600">Receive Sunday attendance reminders</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <label htmlFor="notifications.meetingMinutes" className="block text-sm font-medium text-gray-900">
                        Meeting Minutes
                      </label>
                      <p className="text-sm text-gray-600">Get notified when new meeting minutes are published</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <label htmlFor="privacy.showEmail" className="block text-sm font-medium text-gray-900">
                        Show Email Address
                      </label>
                      <p className="text-sm text-gray-600">Make your email visible in the member directory</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <label htmlFor="privacy.showPhone" className="block text-sm font-medium text-gray-900">
                        Show Phone Number
                      </label>
                      <p className="text-sm text-gray-600">Make your phone number visible in the member directory</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="max-w-md">
                  <label htmlFor="appearance.theme" className="block text-sm font-medium text-gray-700 mb-2">
                    Theme
                  </label>
                  <select
                    id="appearance.theme"
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      You will be redirected to the authentication provider to update your password.
                    </p>
                  </div>
                  
                  <div className="pt-4 border-t border-gray-200">
                    <h3 className="text-md font-medium text-gray-900 mb-3">Data Management</h3>
                    <button
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      This will remove all locally stored data including attendance records and settings.
                    </p>
                  </div>
                </div>
              </div>

    ...
    >
      ...
      <div className="relative text-center max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
          ...
          <h1 className="mt-2 sm:mt-4 text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-heading font-medium leading-[1.1] sm:leading-tight tracking-wide">
            Connected online
          </h1>
        </div>

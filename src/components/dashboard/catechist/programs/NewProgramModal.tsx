// app/catechist/components/programs/NewProgramModal.tsx
'use client';
...
const SACRAMENT_FOCI = ['Baptism', 'FirstCommunion', 'Confirmation', 'None'] as const;
...
export default function NewProgramModal({ 
  ...
  const [type, setType] = useState<(typeof PROGRAM_TYPES)[number]>('Children');
  const [sacramentFocus, setSacramentFocus] = useState<(typeof SACRAMENT_FOCI)[number]>('None');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Mock API call
    console.log({ name, description, type, sacramentFocus, startDate, endDate });
    setTimeout(() => {
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setSacramentFocus(e.target.value as any)}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
            >

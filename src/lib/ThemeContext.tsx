...
const ThemeContext = () => {
    ...
    return (
        ...
        >
            {/* Sliding knob */}
            <span
                className={`absolute top-1 left-1 w-7 h-7 rounded-full shadow transform transition-transform duration-200 flex items-center justify-center ${isDark ? 'translate-x-[24px] bg-gray-900 text-white' : 'translate-x-0 bg-white text-gray-800'}`}
            >
